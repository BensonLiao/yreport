...
class ReportName extends Model
{
    ...
    /**
     * Get the report_data record associated with the report_name.
     */
    public function reportData()
    {
        return $this->hasMany('App\ReportData', 'rep_no', 'rep_no');
    }

    /**
     * Get the category record associated with the report_name.
     */
    public function category()
    {
        return $this->hasMany('App\ReportCategory', 'rep_no', 'rep_no');
    }

    public function dataAndCategories() {
        return $this->reportData->merge($this->category);
    }
