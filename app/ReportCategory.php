...
{
    /**
     * Get the report_data record associated with the category.
     */
    public function reportData()
    {
        return $this->hasMany('App\ReportData', 'c_id', 'c_id');
        // return $this->hasMany('App\ReportData', 'rep_no', 'rep_no')->where('c_id', $this->c_id);
    }

    /**
     * Get the report_name record associated with the category.
     */
