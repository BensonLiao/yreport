...
{
    /**
     * Get the report_name record associated with the report_class.
     */
    public function reportName()
    {
        return $this->hasMany('App\ReportName', 'class_id', 'class_id');
    }

    /**
     * Get the report_data record associated with the report_class.
     */
    public function reportData()
    {
        // return $this->hasManyThrough('App\ReportData', 'App\ReportName', 'class_id', 'class_id');
        return $this->hasManyThrough(
            'App\ReportData',
            'App\ReportName',
            'class_id', // Foreign key on report_name table...
            'rep_no', // Foreign key on report_data table...
            'class_id', // Local key on report_class table...
            'class_id' // Local key on report_name table...
        );
    }
