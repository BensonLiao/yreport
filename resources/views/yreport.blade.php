<!doctype html>
<html lang="{{ app()->getLocale() }}" style="width: 100%; background-color: #f5f5f5">
    <head>
        <meta charset="utf-8">
        ...
        <title>NTNU Year Report, The Office of Institutional Research</title>
